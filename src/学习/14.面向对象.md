...
- [目录](#目录)
  - [面向对象的概念](#面向对象的概念)
    - [面向对象的基本特性（特点）](#面向对象的基本特性特点)
    - [面向对象的基本原则](#面向对象的基本原则)
  - [类的声明](#类的声明)
    - [类和结构体的区别](#类和结构体的区别)
    - [类的静态数据成员和静态函数成员](#类的静态数据成员和静态函数成员)
    - [const修饰符在类中的用法](#const修饰符在类中的用法)
    - [友元函数和友元类](#友元函数和友元类)
  - [构造函数和析构函数](#构造函数和析构函数)
    - [构造函数](#构造函数)
    - [构造函数常见错误](#构造函数常见错误)
  ...
  - [函数重载（overload）](#函数重载overload)
    - [C语言不支持函数重载的原因](#c语言不支持函数重载的原因)
    - [函数重载的要求和特点](#函数重载的要求和特点)
    - [函数重载和函数覆盖的区别](#函数重载和函数覆盖的区别)
  - [继承](#继承)
